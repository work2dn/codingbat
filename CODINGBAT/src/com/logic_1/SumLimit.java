 ...
 * sum has the same number of digits as a. If the sum has more digits than a, 
 * just return a without b. (Note: one way to compute the number of digits 
 * of a non-negative int n is to convert it to a string with String.valueOf(n) and 
